        ...
        <main>
          ...
          <div className="mt-10 flex items-center gap-2">
            ...
            <strong className="text-gray-100 text-xl">
              <span className="text-ignite-500">+</span> pessoas já estão usando
            </strong>
          </div>
...
export const getServerSideProps = async () => {
  const responsePoolsCount = await api.get('pools/count');
  const responseGuessesCount = await api.get('guesses/count');

  const [responsePoolsCount, ]responseGuessesCount,  = await Promise.all([
    api.get('pools/count'),
